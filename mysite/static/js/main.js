...
function webSocketOnMessage(event){
    ...
    if (action == 'new-offer'){
        ...
        createAnswere(offer, peerUsername, receiver_channel_name);
        return;
    }
...
const loaclVideo = document.querySelector('#local-video');
...
function createAnswere(offer, peerUsername, receiver_channel_name){
    var peer = new RTCPeerConnection(null);
